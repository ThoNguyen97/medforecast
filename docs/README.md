...
| `ra-soat/DanhGia_DongNhat_DB_Store_Backend_2026-09-11.md` | Đồng nhất STA ↔ thủ tục PROD ↔ backend | Chương 3 — dữ liệu |
| `ra-soat/DanhGia_ChuyenSangNhomICD.md` | Vì sao dự báo theo khối ICD thay vì từng mã | Chương 3 |

Bộ huấn luyện và datasheet: `../dataset/v1/`. Kết quả backtest dạng CSV: `../backend/ketqua_backtest/`.
Tài liệu vận hành ở gốc repo: `README.md`, `RUN_LOCAL.md`, `DEPLOY.md`.
